class FfmpegSofa < Formula
  desc "Play, record, convert, and stream audio and video (with custom additions: libmysofa)"
  ...
  conflicts_with "ffmpeg", :because => "both install the same binaries"
